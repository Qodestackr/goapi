...
func run(logger *slog.Logger) error {
	...
	cfg.cookie.secretKey = env.GetString("COOKIE_SECRET_KEY", "65juh2hhju4ugcb3whzowxdd2am4f5u5")
	cfg.db.dsn = env.GetString("DB_DSN", "user:pass@localhost:5432/db")
	cfg.db.automigrate = env.GetBool("DB_AUTOMIGRATE", true)
	cfg.jwt.secretKey = env.GetString("JWT_SECRET_KEY", "3jj7uj3ffwjjtakwzpnmi7egikkbwpfa")
